...
const unreviewed = review.candidates.filter((candidate) => candidate.review_status === "unreviewed");
if (unreviewed.length) {
  throw new Error(`Cannot promote while ${unreviewed.length} candidates remain unreviewed.`);
}
